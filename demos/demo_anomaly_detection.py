...
def main():
    ...
    detector.plot_anomaly_analysis(results, save_path='../plots/anomaly_detection/demo_analysis.png')
    ...
    for i, session in enumerate(streaming_sessions):
        ...
        print(f"   Session {session['session_id']}: {status} (Score: {anomaly_score:.3f})")
